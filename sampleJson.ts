...
const filterByEmployees = (employee: string) => {
  return jsonDataFormat2.companyData.projects
    ...
    .map((project: any) => project.status)
    .toString();
};
...
const isObjectExistsJsonDataFormat4 = () => {
  if ("projectsaa" in jsonDataFormat4[0].companyData) {
    console.log("Yespppppppppppppppppppp");
  } else console.log("Nopppppppppppppppppp");
};

console.log(isObjectExistsJsonDataFormat4()); //Output --> Yes
